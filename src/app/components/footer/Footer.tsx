...
import image1 from "../../../../public/images/imageSvg1.svg"


function Footer() {
  return (
    <>
      <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-black" id="footer-section">
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
          <div>
            ...
            >
              <Image
                className=" object-full  bg-gray-200   mx-auto block sm:mx-0 sm:block  rounded-full"
          ...
          <ul className="text-center">
            ...
            <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-neutral-600">
              <a
                className="inline-flex gap-x-2 text-sm text-gray-500 hover:text-blue-800 focus:outline-none focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                href="/about-us"
              >
                About
              </a>
          ...
          <div className="md:text-end space-x-2 mx-auto block sm:mx-0 sm:block" >
            <a
            ...
            <a
              ...
              href="#"
            >
             <Image src={image1} width={16} height={16} alt="image" className="object-cover  bg-slate-300 "/>
            </a>
          </div>
        </div>
      </footer>
