          ...
          <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-4 grid">
                <button
                  type="submit"
                  className="w-full py-3 px-4 inline-flex text-white font-semibold justify-center items-center gap-x-2 text-sm  rounded border border-transparent bg-themeorange bg-pink-400 hover:bg-sky-400 transition-all duration-100 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                >
                  Send inquiry
                </button>
              </div>
          ...
          <div className="divide-y divide-gray-200">
            <div className="flex gap-x-7 py-6">
              ...
              <div className="grow">
                ...
                <a
                  ...
                  href="https://maps.app.goo.gl/qrpiouVmQyiRFm7QA"
                >
                  Shiv Build Tech TDI City, Kundli, Sonipat
                  <svg
            ...
            <div className="flex gap-x-7 py-6">
              ...
              <div className="grow">
                ...
                <a
                  className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                  href="mailto:dineshtushir1982@gmail.com"
                >
                  Send Email
                  <svg
                    className="shrink-0 size-2.5 transition ease-in-out group-hover:translate-x-1 group-focus:translate-x-1 text-gray-600"
